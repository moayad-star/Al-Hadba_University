...
class Al_Hadba():
    ...
    def LoginPage(self):
        ...
        mail_label = Label(left_frame, text="Enter your mail:")
        mail_entry = Entry(left_frame)
        ...
        login_button = Button(left_frame, text="LOGIN",
            ...
            command=lambda: self.login_process(mail_entry, passwd_entry))

        # pack
        left_frame.pack(side="left", padx=20, pady=20, fill="y")
        welcome_label.pack(pady=5)
        mail_label.pack(pady=5, padx=10)
        mail_entry.pack(pady=0, padx=10)
    ...
    def Switch(self):
        ...
        self.__browser["PhoneNumber"] = self.__mail
